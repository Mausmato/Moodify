...
function CanvasComponent(_a, forwardedRef) {
    ...
    if (size.width > 0 && size.height > 0) {
        ...
        root.current.configure(Object.assign(Object.assign({}, props), { dpr: dpr || props.dpr, size: Object.assign(Object.assign({}, size), { top: 0, left: 0 }), events: events$1 || events })).render(jsx(ErrorBoundary, { set: setError, children: jsx(React.Suspense, { fallback: jsx(Block, { set: setBlock }), children: jsx(MotionCanvasContext.Provider, { value: {
                        dimensions,
                        layoutCamera,
    ...
    return (jsx("div", { ref: containerRef, id: id, className: className, tabIndex: tabIndex, style: Object.assign({ position: "relative", width: "100%", height: "100%", overflow: "hidden" }, style), children: jsx("canvas", { ref: mergeRefs([canvasRef, forwardedRef]), style: { display: "block" }, children: fallback }) }));
}
